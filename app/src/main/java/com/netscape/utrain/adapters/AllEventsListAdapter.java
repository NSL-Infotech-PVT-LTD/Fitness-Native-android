...
public class AllEventsListAdapter extends RecyclerView.Adapter<AllEventsListAdapter.AllEventsListHolder> {

    private Context context;
    private List<C_EventDataListModel> list;

    public AllEventsListAdapter(Context context, List<C_EventDataListModel> list) {
    ...
    public void onBindViewHolder(@NonNull AllEventsListHolder holder, int position) {
        ...
        holder.bookingTicketTv.setText(data.getGuest_allowed()+"");
    ...
    public class AllEventsListHolder extends RecyclerView.ViewHolder {
        ...
        AppCompatImageView bookingEventImage;       // Using the booking.view layout which is same for completed....
